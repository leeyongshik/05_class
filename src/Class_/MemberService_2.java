...
public class MemberService_2 {
	private MemberDTO_2[] ar = new MemberDTO_2[5]; //초기값으로 null
	...
	public void insert() {
		...
		ar[i] = new MemberDTO_2(name, age, phone, address);
